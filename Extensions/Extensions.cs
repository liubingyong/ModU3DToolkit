...
public static class AnimatorExtensions
{
    ...
    public static void TrySetTrigger(this Animator self, string name)
    {
        if (self.HasParameter(name, AnimatorControllerParameterType.Trigger))
        {
            self.SetTrigger(name);
        }
    }

    public static void TrySetBool(this Animator self, string name, bool value)
    {
        if (self.HasParameter(name, AnimatorControllerParameterType.Bool))
        {
            self.SetBool(name, value);
        }
    }

    public static void TrySetFloat(this Animator self, string name, float value)
    {
        if (self.HasParameter(name, AnimatorControllerParameterType.Float))
        {
            self.SetFloat(name, value);
        }
    }

    public static void TrySetInteger(this Animator self, string name, int value)
    {
        if (self.HasParameter(name, AnimatorControllerParameterType.Int))
        {
