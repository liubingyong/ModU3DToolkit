...
Shader "Hidden/TransitionsFX"
{
	Properties
	{
		...
		[MaterialToggle] _IgnoreTransitionTex("IgnoreTransitionTex", Float) = 0
	}
	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag(v2f i) : SV_Target
			{
				...
				if (_IgnoreTransitionTex) 
					col = (col * (1 - _Cutoff)) + (_Color * _Cutoff);
				else {
