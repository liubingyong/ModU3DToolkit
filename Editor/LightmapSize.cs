...
{
    [MenuItem("ModU3DToolkit/LightmapSize/AtlasSize_512")]
    static void Init()
    {
...
{
    [MenuItem("ModU3DToolkit/LightmapSize/AtlasSize_1K")]
    static void Init()
    {
...
{
    [MenuItem("ModU3DToolkit/LightmapSize/AtlasSize_2K")]
    static void Init()
    {
...
{
    [MenuItem("ModU3DToolkit/LightmapSize/AtlasSize_4K")]
    static void Init()
    {
