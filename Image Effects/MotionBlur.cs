...
using UnityEngine;
using ModU3DToolkit.ImageEffects;

[ExecuteInEditMode]
[RequireComponent(typeof(Camera))]
[AddComponentMenu("ModU3DToolkit/Image Effects/Motion Blur")]
...
Shader ""Hidden/MotionBlurBlend""  {
    ...
    protected bool CheckResources()
    {
        ...
        blurMat = Helper.CreateMaterial(Shader.Find("Hidden/ModU3DToolkit/MotionBlur"), blurMat);
        if (null == blurMat)
            return false;

        objBlurShader = Shader.Find("Hidden/ModU3DToolkit/MotionBlurObject");
